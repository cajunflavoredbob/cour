...
## Icon tile
For app-icon duty, set the mark on a rounded square of `--bg-2` `oklch(0.24 0.014 85)` with subtle 1px `oklch(1 0 0 / 0.16)` inner border; mark occupies ~60% of tile width, optically centered (nudge left ~2% because the c opens right). Tile radius ≈ 23% of tile size (28px at 120px).
